...
class Api:
    ...
    async def create_entitlement_grants_upload_url(
        ...
        ================
            `str` :
                ...
                Note: You must replace_slashes all occurrences of \u0026 with an ampersand (&) character. See the Drops Guide.
        ...
        ================
            `dict` {
                ...
                'thumbnail_url': `str`
                    ...
                    You can replace_slashes {width} and {height} with any values to get that size image.
    ...
    async def get_users(
            ...
            limit: int,
            user_id: Union[Iterable[str], str] = None,
            login: Union[Iterable[str], str] = None
    ) -> AsyncGenerator[dict, None]:
        """
        |Async Generator|
        ================
